...
class Population:
    ...
    def next_gen(self):
        ...
        champ_fitness = 0
        for s in self.species:
            if s.champion.fitness > champ_fitness:
                if champ_fitness > old_fitness:
                    champ_fitness = s.champion.fitness
        print("-----")
        print("Generation " + str(self.generation) + " Completed")
        print("Champ Fitness: " + str(champ_fitness))
        print("-----")
        children = []
